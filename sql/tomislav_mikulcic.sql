-- ===============================================
-- UPIT 1: Linije s najvećim kapacitetom vozila u voznom redu
...
-- ===============================================
-- UPIT 2: Zaposlenici vozači s najviše smjena i njihove linije
...
-- ===============================================
-- UPIT 3: Prihod od karata po kategoriji putnika
...
SELECT
  ...
  (
    ...
    WHERE kor.kategorija_id = kp.id
  ) AS broj_prekrsaja
FROM kategorija_putnik kp
...
-- ============================================================
-- PROCEDURA 1: sp_podmiri_kazne_korisnika
-- Opis:
...
-- ============================================================
-- PROCEDURA 2: sp_prijavi_servis_i_oznaci_van_prometa
-- Opis:
...
-- ============================================================
-- TRIGGER: trg_prekrsaj_after_insert_suspend
-- Opis:
--   - Nakon unosa novog prekršaja (AFTER INSERT na tablici prekrsaji)
--     prebroji koliko korisnik trenutno ima neplaćenih prekršaja
--   - Ako korisnik ima 3 ili više neplaćenih prekršaja:
--       automatski suspendira korisnika (status_racuna = 'Suspendiran')
--   - Ne radi ništa ako je korisnik već suspendiran
-- ============================================================
DELIMITER //
